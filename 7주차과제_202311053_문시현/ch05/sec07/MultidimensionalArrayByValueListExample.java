...
public class MultidimensionalArrayByValueListExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("scores[0][2]: " + scores[0][2]);//1행의 3번째
		System.out.println("scores[1][1]: " + scores[1][1]);//2행의 2번째
		
		int class1Sum = 0;
		for(int i=0; i<scores[0].length; i++) {
			class1Sum += scores[0][i]; //1행의 열
		}
